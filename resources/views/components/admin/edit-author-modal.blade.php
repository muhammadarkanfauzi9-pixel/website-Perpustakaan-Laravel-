<!-- Edit Author Modal -->
<div id="edit-modal" class="fixed inset-0 bg-gray-800 bg-opacity-50 hidden items-center justify-center">
        ...
        <div class="p-4">
            ...
            <div class="flex justify-between mt-4">
                ...
                <form id="delete-form" method="POST"
                      onsubmit="return confirm('Yakin ingin menghapus author ini?')" class="inline">
                    @csrf
                    @method('DELETE')
